...
def test_web_runner_tree_defaults_to_collapsed():
    assert "let EXPANDED_NODES_KEY = 'lounger.webRunner.expandedNodes';" in _FALLBACK_HTML
...
def test_web_runner_sidebar_is_resizable():
    ...
    assert "let SIDEBAR_WIDTH_KEY = 'lounger.webRunner.sidebarWidth';" in _FALLBACK_HTML
